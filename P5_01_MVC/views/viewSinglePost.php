...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            ...
            <a class="navbar-brand" href="accueil"><img style="border-radius: 10px;" src="public/assets/img/logo.png" class=" w-10" id="logo" alt="logo">
        </a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="post&admin">Ajouter un poste</a></li>
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="public/assets/MonCV.pdf">Mon CV</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="post&connexion"><?php 
                           ...
                           if (isset($_SESSION['usersname'])){
                            ...
                            ?></a></li>
          <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="public/assets/MentionsLegales.pdf">Mentions Légales</a></li>
