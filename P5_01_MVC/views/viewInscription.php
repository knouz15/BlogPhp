      ...
      <header class="masthead" style="background-image: url('public/assets/img/inscription.jpg')">
       ...
       <main class="mb-4">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <p>Après validation de votre compte, vous pourrez créer vos articles!</p>
...
<div class="my-5">
                            ...
                            <form method="post" action="post&send=new"  id="contactForm">
                                ...
                                <div>
                                  ...
                                  <label for="scales"><small>En cochant cette case je confirme avoir pris connaissance des <a href="public/assets/ConditionsGeneralesUtilisation.pdf"><b> CGU </b></a></small></label>
                                </div>                                                                                        
