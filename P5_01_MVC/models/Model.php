    ...
    protected function getAll($table, $obj)
        ...
        protected function getAllUsers($table, $obj)
       {
                ...
                protected function createNewUser($table, $obj)
        {
          ...
          $password_hash = password_hash($_POST['pw'], PASSWORD_DEFAULT, ['cost'=> 10]);//hashage mots de passe avec coùt pour complexité du mot de passe 
        ...
        protected function login($table, $obj)
        {
          ...
          $login_secured=addslashes($_POST['email']);//injection sql
        ...
        protected function checkUserEmail($table, $header)
        {
          ...
          $query->execute(array(htmlspecialchars($_POST['email'])));//faille xss
